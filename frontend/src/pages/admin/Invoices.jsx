  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        ...
        <button onClick={onList} className="border px-4 py-2 rounded">加载发票</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
        ...
        <button onClick={onGenerate} className="bg-primary text-white px-4 py-2 rounded">生成发票</button>
        ...
        <button onClick={onPush} className="border px-4 py-2 rounded">推送 Stripe</button>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
        ...
        <button onClick={onQuery} className="border px-4 py-2 rounded">查询发票详情</button>
      </div>
